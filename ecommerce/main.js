...
cartIconBtn.addEventListener('click', ()=>{
    ...
    if(lastValue === 0){
        productContainer.innerHTML = '<p class="cart-empty">Vacio</p>';
    }else{
        drawProductInModal();
    }
...
function drawProductInModal(){
    productContainer.innerHTML = `
        <div class="cart-modal__details-container">
            ...
            <div>
            <p class="cart-modal__product">Gold Suede</p>
            <p class="cart-modal__price">$1,499 x3 <span>$375.00</span> </p>
            </div>
    ...
    deleteProduct()
    let priceModal = document.querySelector('.cart-modal__price');
    priceModal.innerHTML = `$1,499 x${lastValue} <span>$${lastValue*1499}.00</span>`;
}
